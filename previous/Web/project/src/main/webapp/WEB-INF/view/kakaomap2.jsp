...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(37.500020, 127.112212), // 지도의 중심좌표
        level: 6 // 지도의 확대 레벨
    };
...
positions.push({content:'<div>${lots.prkplceNm}</div>', 	
	latlng: new kakao.maps.LatLng(${lots.latitude}, ${lots.longitude})})
